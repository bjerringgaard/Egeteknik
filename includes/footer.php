<div id="footercontainer">
    <section id="demo">
        <div id="demoContent">
            <div id="demoText">
                <h2>Gør fejlsøgningen nemmere</h2>
                <p>Bestil en demo eller kontakt os</p>
            </div>
            <div id="demoBtn">
    ...
    <section id="sitemap">
        <div id="sitemap_wrapper">
            <div class="logo" href="">
                ...
                <!-- <style type="text/css">.st0{fill:#008DA7;}</style> -->
                <g id="Layer_2_1_">
                    <g id="Layer_1-2">
                        <g id="Logo">
                ...
                <div id="soMe">
                    <a href="https://www.facebook.com/egeteknik.dk"><i class="fab fa-facebook-f"></i></a>
                    <a href="https://www.linkedin.com/company/egeteknikdk"><i class="fab fa-linkedin-in"></i></a>
                </div>
                <ul>
                    <li><div id="copy"><p>&copy; Copyright </p> <p id="date"></p> <p> |   Egeteknik</p></div></li>
                    <li><a href="https://www.bjerringgaard.com/">Designet og udviklet af Marcus Bjerringgaard</a></li>
                </ul>
            </div>
            <div class="product">
                <h3>Produkter</h3>
                <ul>
                    <li><a href="/produkter/cv">Commercial Vehicles</a></li>
                    <li><a href="/produkter/agv">Agricultural Vehicles</a></li>
                    <li><a href="/produkter/ohw">Off-Highway Vehicles</a></li>
                    <li><a href="/produkter/marine">Marine Vessels</a></li>
                    <li><a href="/produkter/jaltest">Jaltest</a></li>
                    <li><a href="/produkter/induction">Induction Innovations</a></li>
                </ul>
            </div>
            <div class="company">
                <h3>Firmaet</h3>
            ...
            <div class="contact">
                <h3>Kontakt</h3>
                <ul>
                    <li><a href="/demo">Bestil Demo</a></li>
